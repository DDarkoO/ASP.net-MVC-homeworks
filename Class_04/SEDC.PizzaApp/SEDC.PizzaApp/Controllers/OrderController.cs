...
namespace SEDC.PizzaApp.Controllers
{
    public class OrderController : Controller
    {
        public IActionResult Index()
        {
            ...
            // ViewData e praktichno Dictionary kade kluchot e sekogash string, a vrednosta mozhe da bide razlichen tip. Eden ViewData e samo za eden key-value par
        ...
        public IActionResult Details(int? id)
        {
            ...
            if(orderDb == null)
            {
                ...
                return View("ResourceNotFound"); //we pass the name of the View as string
            }
